...
This project delivers a **production-grade, end-to-end data engineering pipeline** on **Databricks (Free Edition)** to unify the data infrastructure of **Atlikon** (parent company, sports equipment FMCG) and its newly acquired subsidiary **Sports Bar** (energy bar startup). 
